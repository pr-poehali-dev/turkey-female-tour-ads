...
const tourDays = [
  { 
    ...
    description: 'С вашего первого дня максимально созданы условия, способствующие расслаблению, создана атмосфера безопасности и доверия. Вы окажетесь в уютном отеле, где вас ждёт оформление и размещение. Предлагаем насладится отдыхом после поездки, сонастроиться с энергиями города, предвкушая незабываемые дни впереди.' 
  },
  { 
    day: 2, 
    title: 'Погружение в атмосферу Мармариса', 
    description: 'После вкусного завтрака в отеле начнется ваше знакомство с Мармарисом — жемчужиной побережья Эгейского моря. Прогуливаясь по узким улочкам Старого города, вы почувствуете дыхание истории. Белые домики с деревянными балконами, уютные кафе, лавки с ремесленными изделиями и атмосферные переулки создают особый колорит, который невозможно забыть. Посещение пещеры Нимара, которая находится на Райском острове в Мармарисе. Археологические раскопки показали, что здесь существовала человеческая деятельность с 12 000 лет назад. Пещера известна своими сталактитами и сталагмитами, а также артефактами, которые свидетельствуют о культуре древних обществ. Пещера была объявлена археологическим памятником первой категории, что обеспечивает её защиту и сохранность. Также существует легенда о том, что в ней проживала древнегреческая богиня по имени Лето, мать Артемиды и Аполлона. Вечером, когда солнце будет садиться за горизонт, вы насладитесь ужином на берегу моря, слушая шум волн и чувствуя легкий морской бриз. В женском кругу мы поделимся своими мыслями и желаниями, определяя запросы на этот ретрит.' 
  },
  { 
    day: 3, 
    title: 'Путешествие в Султание — оазис здоровья', 
    description: 'После завтрака мы отправимся в Султание, где вас ждут термальные источники с целебными водами. 5 дней наслаждения, расслабления, очищения. На выезде из Мармариса остановимся на Аллее Любви. Это эвкалиптовая аллея, которая также известна как Аллея Любви. Также это старая дорога, которая соединяла Акьяку и Мармарис. Около тысячи эвкалиптов было высажено в 1938 году, чтобы осушить территорию. Позже аллею использовали для съемок трагических сцен расставания во многих турецких фильмах, откуда она и получила свое название. Термальные источники в Султание известны своими уникальными свойствами и многочисленными примерами оздоровления людей: горячие воды содержат минералы, которые помогают при различных заболеваниях, таких как артрит, заболевания кожи и проблемы с опорно-двигательным аппаратом. Погружение в термальные бассейны способствует улучшению кровообращения, снятию мышечного напряжения и расслаблению нервной системы. Здесь вы сможете насладиться размещением в комфортабельных условиях и погрузиться в мир расслабления. Вечером вас ждет ужин, а затем в женском кругу мы проведем практику очищения свечами. Живой огонь свечи является порталом между мирами, точкой концентрации духовного света в физической реальности. Проведем очищение родовых сценариев, ограничивающих убеждений на пути к здоровой и счастливой жизни.' 
  },
  { 
    day: 4, 
    title: 'Утро в термальных водах', 
    description: 'Каждое утро здесь начинается с красивого рассвета над озером Кёйджегиз и целительного волшебства термальных бассейнов. Польза горячих источников не только в физическом восстановлении, но и в эмоциональной разгрузке. Тепло воды помогает снять стресс и напряжение, а также способствует улучшению сна. Свежевыжатый сок даст организму порцию витаминов, которые так необходимы для иммунной системы и поддержания молодости. После завтрака вы сможете насладиться свободным временем, погружаясь в горячие источники или просто отдыхая на природе. Днем пройдет Мастер-класс по Нейрографике. Нейрографика является научным запатентованным авторским методом работы с подсознанием, который сочетает в себе искусство, психологию и нейронауку. Этот метод помогает снизить стресс, проработать внутренние конфликты и изменить установки, влияющие на жизнь. Нейрографика основана на рисовании специальных «нейролиний» — плавных, непрерывных линий, которые символизируют изменение мышления. Эти линии активизируют нейронные связи, создавая новые модели восприятия и мышления к вашей счастливой жизни. Ужин станет завершающим аккордом дня. А вечером мы соберемся в женском кругу для общения и медитации.' 
  },
  { 
    day: 5, 
    title: 'Погружение в себя', 
    description: 'Утро снова начнется со встречи рассвета, свежевыжатого сока, термальных источников. Свободное время позволит вам насладиться природой и атмосферой этого уникального места. В течении дня в индивидуальном коуч-формате пройдет расстановочная сессия на БоГобан. БоГобан - это не только специальная магнитная доска, на которой можно ставить камни, а и "живое поле", где каждый камень, каждая точка, каждое пересечение линий отвечает за какой-то смысл вашего запроса. За два часа индивидуальной работы вы получаете ясность и осознанность, которые обычно требуют длительной проработки. Инсайт приходит мгновенно, показывая тот самый «невидимый шаг». Вечером мы снова соберемся в женском кругу для общения и медитации.' 
  },
  { 
    day: 6, 
    title: 'Дни без забот', 
    description: 'Эти дни будут наполнены радостью и свободой. Каждое утро начинается с завтрака и погружения в термальные бассейны. Вы сможете наслаждаться свободным временем — читать книги, гулять по живописным окрестностям или просто медитировать у воды. Вечером мы собираемся в женском кругу, создавая пространство для обмена опытом и поддержания друг друга.' 
  },
  { 
    day: 7, 
    title: 'Дни без забот', 
  ...
  { 
    day: 9, 
    title: 'Праздник жизни', 
    description: 'Завтрак в отеле станет началом праздничного дня! После него вас ждёт фотосессия на фоне живописных пейзажей в Мармарисе, чтобы запечатлеть эти волшебные моменты. Свободное время позволит вам насладиться атмосферой города, а вечер завершится ужином-сюрпризом.' 
  },
  { 
    day: 10, 
  ...
  { 
    ...
    description: 'После завтрака у вас будет свободное время для последних мгновений отдыха и размышлений о вашем путешествии. Затем наступит момент расставания — время разъезда, полное воспоминаний о незабываемых днях, проведённых в женской компании единомышленниц.' 
  },
];
            ...
            <div className="flex flex-col items-center gap-6 bg-white rounded-3xl p-8 shadow-lg">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Светлана Якут — мастер Рейки и НейроГрафики, специалист БоГобан. Мама двоих детей, ведущая ретритов и женских практик. С более чем десятилетним опытом жизни в Турции, она создает уникальную атмосферу для отдыха и личностного роста.
                </p>
              </div>
            </div>
          </div>
