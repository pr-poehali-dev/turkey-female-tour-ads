            ...
            <div className="flex flex-col items-center gap-6 bg-white rounded-3xl p-8 shadow-lg">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Светлана Якут — мастер Рейки и НейроГрафики, специалист БоГобан, вдохновляющая женщин на самопознание и трансформацию. Мама двоих детей, ведущая ретвитов и женских практик. С более чем десятилетним опытом жизни в Турции, она создает уникальную атмосферу для отдыха и личностного роста.
                </p>
              </div>
            </div>
          </div>
